...
/** Normalize API category string to our union. */
...
/** Material Symbols names (match Stitch smart shopping list). */
...
/** Bento grid column spans at lg+ (12-col grid). Two cards per row = span 6 each. */
