...
| POST | `/recipes/parse/link` | Returns a draft Recipe from a supported public HTTPS YouTube/TikTok URL **without saving** — YouTube uses caption tracks; TikTok uses public oEmbed title/caption text only; caller edits then `POST /recipes` |
